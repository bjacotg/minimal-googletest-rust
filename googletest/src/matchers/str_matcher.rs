...
impl<ExpectedT, MatcherT: Into<StrMatcher<ExpectedT>>>
    StrMatcherConfigurator<ExpectedT> for MatcherT
{
    fn ignoring_leading_whitespace(self) -> StrMatcher<ExpectedT> {
...
impl<A: ?Sized, T: Deref<Target = str>> From<EqDerefOfMatcher<A, T>> for StrMatcher<T> {
